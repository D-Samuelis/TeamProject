...
@section('head')
    <link
        href="https://fonts.googleapis.com/css2?family=DM+Serif+Display&family=DM+Sans:ital,wght@0,300;0,400;0,500;1,400&display=swap"
        rel="stylesheet">
    <style>
        :root {
            --ink: #1c1c1c;
...
@section('content')
    <div class="book-wrap">
        ...
        <div class="book-header">
            ...
            <div class="meta">
                ...
                <br>
                <span>⏱ {{ $service->effective_duration }} minutes</span>
            </div>
        </div>
        ...
        <div class="book-layout">
            ...
            <div class="slots-card">
                ...
                <div class="confirm-strip" id="confirmStrip">
                    <div class="confirm-row"><span class="lbl">Service:</span>
                        <span class="val">{{ $service->service->name }}</span>
                    </div>
                    <div class="confirm-row">
                        <span class="lbl">Asset:</span>
                        <span class="val">{{ $asset->name }}</span>
                    </div>
                    <div class="confirm-row">
                        <span class="lbl">Date:</span>
                        <span class="val" id="cfDate">–</span>
                    </div>
                    <div class="confirm-row">
                        <span class="lbl">Time:</span>
                        <span class="val" id="cfTime">–</span>
                    </div>
                    <div class="confirm-row">
                        <span class="lbl">Duration: </span>
                        <span class="val">{{ $service->effective_duration }} min</span>
                    </div>
    ...
    <script>
        (function() {
            ...
            const DURATION = {{ $service->effective_duration }};
            ...
            function renderSlots() {
                ...
                if (!slots) {
                    document.getElementById('slotsBody').innerHTML =
                        `<div class="slots-loading"><span class="spinner"></span></div>`;
                ...
                if (slots.length === 0) {
                    document.getElementById('slotsBody').innerHTML =
                        `<div class="slots-closed">Closed — no available slots.</div>`;
                    document.getElementById('confirmStrip').classList.remove('show');
                    return;
                }
