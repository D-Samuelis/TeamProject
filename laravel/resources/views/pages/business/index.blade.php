    ...
    <div class="business">
        <aside class="business__sidebar">
            ...
            <section class="business__status-filters">
                ...
                <div id="statusList" class="dropdown__mini-list"></div>
            </section>
        </aside>
            ...
            <form method="POST" action="{{ route('manage.business.store') }}">
                ...
                <div class="business__search-container mb-4" style="width: 100%; height: auto;">
                    <textarea name="description" placeholder="Description (optional)"
                        style="width: 100%; border: none; background: transparent; outline: none; padding: 5px; min-height: 80px;"></textarea>
                </div>
                <div class="d-flex gap-2">
                    <button type="submit" class="business__nav-link is-active" style="border: none; cursor: pointer;">
                        Save Business
                    </button>
                    <button type="button" class="business__nav-link modal-close-trigger"
