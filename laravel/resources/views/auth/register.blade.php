...
@section('content')
    <div class="card bg-gray-800 p-8 rounded-xl shadow-lg max-w-md mx-auto mt-16">
        <h1 class="text-4xl font-extrabold text-cyan-400 text-center mb-6 drop-shadow-lg">Register</h1>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div class="form-group flex flex-col">
                <label for="name" class="text-cyan-400 font-semibold mb-1">Name</label>
            ...
            <div class="form-group flex flex-col">
                <label for="password_confirmation" class="text-cyan-400 font-semibold mb-1">Confirm Password</label>
            ...
            <div class="form-actions flex justify-between items-center mt-6">
                <button type="submit"
                    class="px-6 py-3 cursor-pointer bg-cyan-100 hover:bg-cyan-400 text-gray-900 font-semibold rounded-lg shadow-md hover:shadow-lg transition duration-200">
                    Register
                </button>
                <a href="{{ route('login') }}"
